...
for graph in ${graph_list[@]}; do
    ...
    if [[ ! $graph =~ $pat4 ]]; then
        ...
        run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/metadata> DELETE { <$graph> void:classPartition [void:class ?c ] . } WHERE { <$graph> void:classPartition [void:class ?c ] . };"
        ...
        run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/metadata> DELETE { <$graph> void:classPartition [void:class ?class ; void:entities ?count ] . } WHERE {<$graph> void:classPartition [void:class ?class ; void:entities ?count ] . };"
        ...
        run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/metadata> DELETE { <$graph> void:classPartition [void:class ?c ; void:triples ?x ] . } WHERE { <$graph> void:classPartition [void:class ?c ; void:triples ?x ] . };"
        ...
        run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/metadata> DELETE { <$graph> void:classPartition [void:class ?c ; void:properties ?x ] . } WHERE { <$graph> void:classPartition [void:class ?c ; void:properties ?x ] . };"
        ...
        run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/metadata> DELETE { <$graph> void:classPartition [void:class ?c ; void:classes ?x ] . } WHERE { <$graph> void:classPartition [void:class ?c ; void:classes ?x ] . };"
        ...
        run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/metadata> DELETE { <$graph> void:classPartition [void:class ?c ; void:distinctSubjects ?x ] . } WHERE { <$graph> void:classPartition [void:class ?c ; void:distinctSubjects ?x ] . };"
        ...
        run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/metadata> DELETE { <$graph>  void:classPartition [void:class ?c ; void:distinctObjects ?x ] . } WHERE { <$graph>  void:classPartition [void:class ?c ; void:distinctObjects ?x ] . };"
        ...
        run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/metadata> DELETE { <$graph> void:classPartition [void:class ?c ; void:propertyPartition [void:property ?p ; void:triples ?x ] ] . } WHERE { <$graph> void:classPartition [void:class ?c ; void:propertyPartition [void:property ?p ; void:triples ?x ] ] . };"
        ...
        run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/metadata> DELETE { <$graph>  void:classPartition [void:class ?c ; void:propertyPartition [void:property ?p ; void:distinctSubjects ?x ] ] . } WHERE { <$graph>  void:classPartition [void:class ?c ; void:propertyPartition [void:property ?p ; void:distinctSubjects ?x ] ] . };"
        ...
        run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/metadata> DELETE { <$graph> void:propertyPartition [void:property ?p ; void:triples ?x ] . } WHERE { $graph> void:propertyPartition [void:property ?p ; void:triples ?x ] . };"
        ...
        run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/metadata> DELETE { <$graph> void:propertyPartition [void:property ?p ; void:distinctSubjects ?x ] . } WHERE { <$graph> void:propertyPartition [void:property ?p ; void:distinctSubjects ?x ] . };"
        ...
        run_virtuoso_cmd "SPARQL PREFIX void: <http://rdfs.org/ns/void#> WITH <${DOMAIN}/graph/metadata> DELETE { <$graph> void:propertyPartition [void:property ?p ; void:distinctObjects ?x ] . } WHERE { <$graph> void:propertyPartition [void:property ?p ; void:distinctObjects ?x ] . };"
